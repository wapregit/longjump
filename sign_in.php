...
<body>
    ...
    <main class="main h-100 w-100 d-flex position-relative" style="background: linear-gradient(#aeabf2, white);">
        <div class="w-50 h-100 position-absolute start-0 z-1" style="clip-path: polygon(0 0, 100% 0, 93% 100%, 0% 100%);">
            <img src="include/image/background2.jpg" class="w-100 h-100" />
        </div>
        ...
        <div class="d-flex flex-column justify-content-center align-items-center w-50 h-100 position-absolute end-0 text-center">
            ...
            <form class="card text-start w-50 rounded-4 px-4 py-4" style="background: rgb(98, 159, 202);" action="include/backend/login.php" method="post">
                <div class="div-username mb-3">
                    <label class="form-label" for="username">ชื่อผู้ใช้</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text rounded-start" id="icon-user"><i class="bi bi-person-fill"></i></span>
                        </div>
                ...
                <div class="div-password mb-3">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="icon-password" style="border-top-right-radius: 0;
    border-bottom-right-radius: 0;"><i class="bi bi-key-fill"></i></span>
                        </div>
