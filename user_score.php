...
<body>
    <main style="background-color: #D9E1E4">
        <div class="d-flex flex-column align-items-center py-4">
            <div class=" div-select-program d-flex justify-content-between m-auto p-3">
                <form class="form d-flex" id="form-select-program" method="post">
                    ...
                    <select name="select-program" id="select-program" class="form-select form-select-lg">
                        ...
                        <?php foreach ($select_program as $select_program) { ?>
                            <option value="<?= $select_program['program_id']; ?>" <?php if (isset($_POST['select-program']) && $_POST['select-program'] == $select_program['program_id']) echo "selected"; ?>>
                                รายการที่
            ...
            <?php if (isset($_POST['select-program']) && $_POST['select-program'] !== '') { ?>
                <div class="container-table p-4 m-auto rounded-4" style="background-color: #C3CACD;">
                        ...
                        <table class="table table-header">
                            <thead style="text-align: center">
                                ...
                                <?php foreach ($program as $program_table1) { ?>
                                    ...
                                    <tr>
                                        <?php
                                        $program_date = date('d/m/Y', strtotime($program_table1['program_date']));
                                        ...
                                        ?>
                                        <th colspan="2"> <?= $program_thai_date; ?> </th>
                                    </tr>
                                <?php } ?>
                            </thead>
                        </table>
